...
class BookingWindow:   
    ...
    def __init__(self, apparatus_name_admin_input, booking_name_admin_input, booking_department_admin_input, first_slot_date_admin_input):   
        ...
        self.root.configure(bg = 'pale green')
        ...
        try:
            ...
            for slot in slots:
                ...
                if booking_name == self.default_value:
                    calendar_entry = tk.Label(self.root, text = calendar_entry_text, font = cal_font, width = cal_wd, fg = cal_fg, bg = 'SpringGreen3')
                else:
                    calendar_entry = tk.Label(self.root, text = calendar_entry_text, font = cal_font, width = cal_wd, fg = cal_fg, bg = 'IndianRed1')
